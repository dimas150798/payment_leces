...
class M_SudahLunas extends CI_Model
{
    ...
    public function SudahLunas($bulan, $tahun, $tanggalAkhir)
    {
        $query   = $this->db->query("SELECT 
            ...
            data_pembayaran.transaction_time IS NOT NULL AND data_customer.stop_date IS NULL
    ...
    // Menampilkan Data Sudah Lunas Excel
    public function SudahLunasExcel($bulan, $tahun, $tanggalAkhir)
    {
        ...
        GROUP BY data_customer.name_pppoe
        ORDER BY data_customer.kode_customer ASC");
    ...
    public function NominalSudahLunas($bulan, $tahun, $tanggalAkhir)
    {
        ...
        AND data_pembayaran.transaction_time IS NOT NULL AND  data_customer.stop_date IS NULL");
