                        ...
                        <form method="POST" action="<?php echo base_url('admin/DataSales/C_TambahSales/TambahSalesSave') ?>">
                            ...
                            <div class="row">
                                <div class="col-sm-4 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_sales" value="" placeholder="Masukkan nama...">
                                    <div class="bg-danger">
                                ...
                                <div class="col-sm-4 mt-3">
                                    ...
                                    <input type="number" class="form-control" name="phone_sales" value="" placeholder="Masukkan telephone...">
                                    <div class="bg-danger">
